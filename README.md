...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://true-binar-White-Rabbit.github.io/react_carousel/) and add it to the PR description.
