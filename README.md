# React Carousel
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://andriypt82.github.io/react_carousel/)
...
1. implement a carousel described [here](https://github.com/mate-academy/dom_carousel) as a React component
    ...
    ```
2. add an ability to customize `itemWidth` with e of `130px`
