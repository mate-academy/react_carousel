[DEMO LINK](https://artemvlasiuk.github.io/react_carousel/)
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://artemvlasiuk.github.io/react_carousel/) and add it to the PR description.
