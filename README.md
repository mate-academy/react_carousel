...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://elenachernyshova01-cmd.github.io/react_carousel/) and add it to the PR description.
