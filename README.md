...
2. The page should continue the input fields for:
   - `ItemWidth`
   - `FrameSize`
   - `Step`
   - `AnimationDuration`
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://sergey-vorobei.github.io/react_carousel/) and add it to the PR description.
