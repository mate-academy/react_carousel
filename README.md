...
3. add `frameSize` - number of images displayed at the same time with the default of `3` 4
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Pavlo-Petrashevskyi.github.io/react_carousel/) and add it to the PR description.
